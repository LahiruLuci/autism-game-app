  ...
  return (
    <header className="relative z-20 w-full max-w-5xl mx-auto px-6 py-8 flex items-center justify-between">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-black text-slate-800 tracking-tight">Shape Match</h1>
          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 rounded-md bg-sky-50 text-sky-600 text-[10px] font-bold uppercase tracking-widest border border-sky-100">
              Level {level}
            </span>
