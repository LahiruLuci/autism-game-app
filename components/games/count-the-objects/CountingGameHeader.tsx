  ...
  return (
    <header className="relative z-20 mx-auto w-full max-w-5xl px-4 py-4 sm:px-6 sm:py-6">
      ...
      <div className="mt-3 flex flex-col items-center text-center sm:absolute sm:left-1/2 sm:top-1/2 sm:mt-0 sm:-translate-x-1/2 sm:-translate-y-1/2">
        <h1 className="text-xl font-black tracking-tight text-slate-800 sm:text-2xl">Count Objects</h1>
        <div className="mt-1 flex flex-wrap items-center justify-center gap-2">
          <span className="rounded-md border border-cyan-100 bg-cyan-50 px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest text-cyan-600">
            Level {level}
          </span>
