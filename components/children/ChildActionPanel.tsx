      ...
      <div className="flex flex-col gap-3">
        {hasAssessment ? (
          <>
            <Link
              href={`/games/${childId}`}
              className="inline-flex items-center justify-center gap-2 w-full py-4 rounded-2xl bg-blue-600 text-white text-sm font-extrabold shadow-lg shadow-blue-200 hover:bg-blue-700 hover:-translate-y-0.5 transition-all duration-300"
            >
